...
public class ShopsManager3 {
    private final LonelyShopPlugin plugin;
    
    public ShopsManager3(LonelyShopPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void openShopInventory(Player player, ArrayList<ItemForSale> items, ShopType shopType, Material material, byte data) {
        Inventory inventory = LonelyShop2.getShopInventory(plugin.economy, player, shopType, items, material, data, 1);
    ...
    public void onShopAction(InventoryClickEvent e) {
        ...
        if(meta.getDisplayName().equals(LonelyShop2.PREV_PAGE_TEXT) 
        || meta.getDisplayName().equals(LonelyShop2.NEXT_PAGE_TEXT)) {
            ...
            Inventory inventory = LonelyShop.getShopInventory(plugin.economy, player, shopType, items, newPageNumber, material, data);
        ...
        if(shopTitle.equals(LonelyShop2.SHOPTITLE_SCREEN_MY_ITEMS)) {
